...
import (
	...
	"github.com/wns-lab/wns-chain/cmd/wnsd/experimental"
	"github.com/wns-lab/wns-chain/x/wns"
...
func addModuleInitFlags(startCmd *cobra.Command) {
	...
	wns.AddModuleInitFlags(startCmd)
...
func WrapValidateGenesisCmd() *cobra.Command {
	...
	wrapCmd.RunE = func(cmd *cobra.Command, args []string) error {
		experimental, err := cmd.Flags().GetBool(wns.ExperimentalFlag)
		if err != nil {
			return err
		}
	...
	wrapCmd.Flags().Bool(wns.ExperimentalFlag, false, "Enable experimental features")
	return wrapCmd
}
